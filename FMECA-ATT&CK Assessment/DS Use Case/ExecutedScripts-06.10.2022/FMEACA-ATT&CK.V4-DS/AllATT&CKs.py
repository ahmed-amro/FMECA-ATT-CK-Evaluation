...
def CalculateImpact(i,comp,OPMODE,ImpactScores,Matrix,FailureMetrics,FailuteFactors):
	...
	Safety_Factor = float(FactorsInput[1])
	#print("Safety_Factor: ",Safety_Factor)
	Operational_Factor = float(FactorsInput[0])
	#print("Operational_Factor: ",Operational_Factor)
	Financial_Factor = float(FactorsInput[3])
	#print("Financial_Factor: ",Financial_Factor)
	ODC_Factor = float(FactorsInput[4])
	#print("ODC_Factor: ",ODC_Factor)
	Reputation_Factor = float(FactorsInput[6])
	Environmental_Factor = float(FactorsInput[5])
	Privacy_Factor = float(FactorsInput[2])
...
def GetRiskRating(Risk):
	...
	#All1
	Low_Threshold = 4.635583333
	Medium_Threshold = 9.271166667
	High_Threshold = 13.90675
	Critical_Threshold = 18.54233333
	#StagingX10
